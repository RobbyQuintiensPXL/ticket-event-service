...
public class MockMvcEventAdminControllerTests {
    ...
    public void getAllEventsTest() throws Exception {
        ...
        when(eventService.getNewEventsForAdmin(any(Predicate.class), anyInt(), anyInt()))
                .thenReturn(events);

        mockMvc
                .perform(MockMvcRequestBuilders.get("/admin/events")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }

    @Test
    public void approveEventTest() throws Exception {
        init();

        mockMvc
                .perform(MockMvcRequestBuilders.post("/admin/event/{id}/approve", 1))
    ...
    public void deleteEventTest() throws Exception {
        ...
        mockMvc
                .perform(MockMvcRequestBuilders.delete("/admin/event/{id}", 1))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }

//    asJsonString(new CreateEventResource("EventName", EventType.CONCERT.getType(),
//                                "ShortDesc", "Desc", LocalDate.now().plusDays(2), LocalTime.now(),
